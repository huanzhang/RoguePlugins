...
local VERSION = "2.3.7-7-g012168a";
    ...
    return {
        ...
        args = {
            ...
            Version = {
                ...
                guiHidden = true,
                func = function () HHTD:Print(L["VERSION"], '2.3.7-7-g012168a,', L["RELEASE_DATE"], '2016-01-31T03:24:48Z') end,
                order = -5,
            },
            ShowGUI = {
                type = 'execute',
            ...
            core = {
                ...
                args = {
                    Info_Header = {
                        type = 'header',
                        name = L["VERSION"] .. ' 2.3.7-7-g012168a -- ' .. L["RELEASE_DATE"] .. ' 2016-01-31T03:24:48Z',
                        order = 1,
                    },
                    Pve = {
                        type = 'toggle',

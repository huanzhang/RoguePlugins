...
L["CM"] = "Marques personelles" -- Needs review
...
L["OPT_CM_CHANGEMARK"] = "Remplacer par %s" -- Needs review
L["OPT_CM_CHANGEMARK_DESC"] = "Remplace la marque par celle choisie dans le menu '%s'" -- Needs review
L["OPT_CM_CLEARASSOC"] = "Effecacer" -- Needs review
L["OPT_CM_CLEARASSOC_DESC"] = "Efface la marque du nom sélectionné" -- Needs review
L["OPT_CM_CLEARTARGETMARKER"] = "Démarquer la cible" -- Needs review
L["OPT_CM_CLEARTARGETMARKER_DESC"] = "Enlève la marque de la cible" -- Needs review
L["OPT_CM_DESCRIPTION"] = "Ici vous pouvez cibler une unité et y appliquer un marque personnelle uniquement visible par vous. Ces marques persisteront entre les sessions de jeux." -- Needs review
L["OPT_CM_EXISTINGASSOC"] = "Associations nom-marque existantes" -- Needs review
L["OPT_CM_EXISTINGASSOC_DESC"] = "Sélectionner un nom à utiliser avec les autres boutons de cette section" -- Needs review
L["OPT_CM_MARKER_CUSTOMIZATION"] = "Personalisation des marques" -- Needs review
L["OPT_CM_MARKER_MANAGEMENT"] = "Gestion des marques" -- Needs review
L["OPT_CM_SELECT_MARKER"] = "Marque" -- Needs review
L["OPT_CM_SELECT_MARKER_DESC"] = "Sélectionner une marque à appliquer sur votre cible" -- Needs review
L["OPT_CM_SETTARGETMARKER"] = "Marquer la cible" -- Needs review
L["OPT_CM_SETTARGETMARKER_DESC"] = "Marque la cible avec la marque séléctionée" -- Needs review
-- L["OPT_CM_VCa"] = ""
-- L["OPT_CM_VCa_DESC"] = ""
-- L["OPT_CM_VCb"] = ""
-- L["OPT_CM_VCb_DESC"] = ""
...
L["OPT_GUI"] = "Ouvrir l'interface" -- Needs review
L["OPT_GUI_DESC"] = "Ouvre l'interface graphique de configuration" -- Needs review
...
L["OPT_CLEAR_LOGS"] = "Protokolle löschen" -- Needs review
-- L["OPT_CM_CHANGEMARK"] = ""
...
L["OPT_CM_CHANGEMARK"] = "更改成 %s" -- Needs review
-- L["OPT_CM_CHANGEMARK_DESC"] = ""
-- L["OPT_CM_CLEARASSOC"] = ""
-- L["OPT_CM_CLEARASSOC_DESC"] = ""
L["OPT_CM_CLEARTARGETMARKER"] = "清除目標" -- Needs review
L["OPT_CM_CLEARTARGETMARKER_DESC"] = "移除目標的標記圖示" -- Needs review
L["OPT_CM_DESCRIPTION"] = "選取一個對象為目標，加上只有你看得到的自訂標記圖示。這些標記圖示會一直保留。" -- Needs review
-- L["OPT_CM_EXISTINGASSOC"] = ""
-- L["OPT_CM_EXISTINGASSOC_DESC"] = ""
L["OPT_CM_MARKER_CUSTOMIZATION"] = "自訂標記圖示" -- Needs review
-- L["OPT_CM_MARKER_MANAGEMENT"] = ""
L["OPT_CM_SELECT_MARKER"] = "標記圖示" -- Needs review
L["OPT_CM_SELECT_MARKER_DESC"] = "選擇要套用的標記圖示" -- Needs review
L["OPT_CM_SETTARGETMARKER"] = "標記目標" -- Needs review
L["OPT_CM_SETTARGETMARKER_DESC"] = "將選擇的標記圖示套用到選取的目標上" -- Needs review
L["OPT_CM_VCa"] = "半透明" -- Needs review
L["OPT_CM_VCa_DESC"] = "更改圖案的半透明" -- Needs review
L["OPT_CM_VCb"] = "藍色" -- Needs review
L["OPT_CM_VCb_DESC"] = "更改圖案的藍色色調" -- Needs review
L["OPT_CM_VCg"] = "綠色" -- Needs review
L["OPT_CM_VCg_DESC"] = "更改圖案的綠色色調" -- Needs review
L["OPT_CM_VCr"] = "紅色" -- Needs review
L["OPT_CM_VCr_DESC"] = "更改圖案的紅色色調" -- Needs review
...
L["OPT_GUI"] = "開啟圖形介面" -- Needs review
L["OPT_GUI_DESC"] = "開啟圖形設定面板" -- Needs review
